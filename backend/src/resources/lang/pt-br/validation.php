...
return [
    ...
    */
    ...
    'boolean'              => ':Attribute deve ser (1)verdadeiro ou (0)falso.',
    ...
    'unique_attachment'    => ':Attribute já está em uso.',
    'protocol'             => 'O protocolo :attribute é inválido.',
    'uf'                   => ':attribute inválido.',
    ...
    */
    ...
    'custom' => [
        ...
        'signature'      => [
            'signature' => ':Attribute não é uma assinatura válida.',
        ],
        'casesensitive'  => [
            'lowercase' => 'O attribute: deve estar em letras minúsculas.',
        ],
        'not_in'         => [
            'array' => 'O campo :attribute já existe em :other.',
        ],
    ],
